...
<div class="tip">
  ...
  <p>
    아래에서 요약한 <code>in.demo</code> 의 전체 스크립트와 RDF·MSD 분석까지를
    한 페이지에 모은 것이 <a href="ex-02-lj-demo.html">예제 E2 — LJ 5단계</a> 입니다.
  </p>
</div>
...
LAMMPS 22 Jul 2025 직렬 빌드에서 약 7초 만에 완료됐습니다.
...
<figure>
  ...
  <figcaption style="font-size:0.85rem;color:var(--text-muted);text-align:center;margin-top:0.5rem;">
    ...
    in.demo 를 LAMMPS 22 Jul 2025 (conda-forge, 직렬)로 실제 실행해 얻은 값입니다.
  </figcaption>
</figure>
